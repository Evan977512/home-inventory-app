    ...
    return (
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/inventory" element={user ? <Inventory /> : <Signup />} />
                ...
                <Route path="/admin/manageCategory" element={systemAdmin || companyAdmin ? <ManageCategory /> : <Signin />} />
                <Route path="/admin/manageUser" element={systemAdmin || companyAdmin ? <ManageUser /> : <Signin />} />
                <Route path="/admin/manageUser/addUser" element={systemAdmin || companyAdmin ? <AddUser /> : <Signin />} />
                <Route path="/admin/manageUser/editUser/:userId" element={systemAdmin || companyAdmin ? <EditUser /> : <Signin />} />
            </Routes>
